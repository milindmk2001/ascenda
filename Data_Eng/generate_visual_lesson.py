  ...
  "slides": [
    {
      ...
      "learningObjective": "Student can identify repeating patterns in numbers",
      "narration": "Hello! Today we explore patterns using Indian examples.",
      "sequence": [2, 4, 6, 8, 10],
      "rule": "+2",
      "question": "What comes next: 2, 4, 6, 8, ___?",
      "answer": "10",
      "hint": "Each number is 2 more than the previous one",
      "misconception": "Students sometimes add 1 instead of 2"
    }
  ],
  "interactionPolicy": {
...
RULES:
- Create exactly 3 slides, each covering a different number pattern concept
- sequence: a list of 4-5 numbers showing the pattern
- rule: a short string like "+2" or "x3" or "+5"
- narration: 2-3 warm sentences using Indian examples (mangoes, cricket, rupees, Diwali)
- question: simple enough for a 12-year-old
